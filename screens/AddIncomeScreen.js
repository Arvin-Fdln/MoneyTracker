    ...
    >
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        <View style={styles.headerBadge}>
          ...
          <Text style={styles.headerText}>Enter Income Details</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  headerBadge: {
    ...
    backgroundColor: "#E1F5EE", borderRadius: 12, padding: 14, marginBottom: 16,
  },
  headerIcon: { fontSize: 28, marginRight: 10 },
  headerText: { fontSize: 18, fontWeight: "bold", color: "#0F6E56" },
  card: {
  ...
  catChipSelected: { backgroundColor: "#E1F5EE", borderColor: "#1D9E75" },
  button: {
